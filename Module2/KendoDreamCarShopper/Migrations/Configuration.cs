    ...
    internal sealed class Configuration : DbMigrationsConfiguration<EntityStore> {
        ...
        protected override void Seed(EntityStore context) {
            ...
            context.ModelImages.AddOrUpdate(x => new {x.ModelId, x.Order},
                new ModelImage {ModelId = spiderId, ShortDescription = "Front", LongDescription = "Front", Order = 1, HighResolutionUrl = string.Format(spiderImageBase, "Front_HighRez"), LowResolutionUrl = string.Format(spiderImageBase, "Front_LowRez")},
                new ModelImage {ModelId = spiderId, ShortDescription = "Rear", LongDescription = "Rear", Order = 2, HighResolutionUrl = string.Format(spiderImageBase, "Rear_HighRez"), LowResolutionUrl = string.Format(spiderImageBase, "Rear_LowRez")},
                new ModelImage {ModelId = spiderId, ShortDescription = "Side", LongDescription = "Side", Order = 3, HighResolutionUrl = string.Format(spiderImageBase, "Side_HighRez"), LowResolutionUrl = string.Format(spiderImageBase, "Side_LowRez")},
                new ModelImage {ModelId = spiderId, ShortDescription = "Top", LongDescription = "Top", Order = 4, HighResolutionUrl = string.Format(spiderImageBase, "Top_HighRez"), LowResolutionUrl = string.Format(spiderImageBase, "Top_LowRez")},
                new ModelImage {ModelId = aventadorId, ShortDescription = "Front", LongDescription = "Front", Order = 1, HighResolutionUrl = string.Format(aventadorImageBase, "Front_HighRez"), LowResolutionUrl = string.Format(aventadorImageBase, "Front_LowRez")},
                new ModelImage {ModelId = aventadorId, ShortDescription = "Rear", LongDescription = "Rear", Order = 2, HighResolutionUrl = string.Format(aventadorImageBase, "Rear_HighRez"), LowResolutionUrl = string.Format(aventadorImageBase, "Rear_LowRez")},
                new ModelImage {ModelId = aventadorId, ShortDescription = "Side", LongDescription = "Side", Order = 3, HighResolutionUrl = string.Format(aventadorImageBase, "Side_HighRez"), LowResolutionUrl = string.Format(aventadorImageBase, "Side_LowRez")});
